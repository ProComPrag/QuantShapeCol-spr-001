var config = {
	...
	"author": "Stela",
	"experiment_id": "spr-pilot-test-04",
	"description": "spr pilot test-04",
	"liveExperiment": true,
	...
	"expSettings": {
		...
		"pause": 700,
		// help text reminding the participant to press space to see the sentence
		"helpText": "Press the SPACE bar to reveal the sentence."
	},
